...
exports.getColors = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var backGroundColor;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                backGroundColor = [];
                return [4 /*yield*/, data.map(function (obj) {
                        var tempColor;
            ...
            case 1:
                _a.sent();
                return [2 /*return*/, { backGroundColor: backGroundColor, colorsOk: true }];
        }
    });
}); };
